...
// Project imports:
import 'package:hydrated_theme_mode_bloc/hydrated_theme_mode_bloc.dart';
import 'hydrated_theme_mode_bloc_test.mocks.dart';

@GenerateNiceMocks([MockSpec<Storage>()])
void main() {
  late HydratedThemeModeBloc themeModeBloc;
  ...
  setUp(() {
    ...
    themeModeBloc = HydratedThemeModeBloc();
  });

  group('HydratedThemeModeBloc', () {
